...
import PreviewOrderButton from '@/components/order/preview/preview-order-button';
...
export const MenuList = () => {
  ...
  const { restaurantId, qrId, orderId } = useApp();
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      {!(dishPreviewOpen || orderDrawerOpen) && (
        <PreviewOrderButton onOpen={() => setOrderDrawerOpen(true)} />
      )}
